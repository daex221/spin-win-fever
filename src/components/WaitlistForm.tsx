        ...
        <div>
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-12 h-14 text-lg bg-background text-foreground border-2 focus:border-neon-gold focus:shadow-[0_0_20px_rgba(255,215,0,0.4)] ${
        ...
        <div>
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-12 h-14 text-lg bg-background text-foreground border-2 focus:border-neon-cyan focus:shadow-[0_0_20px_rgba(0,255,255,0.4)] ${
        ...
        <div>
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-12 h-14 text-lg bg-background text-foreground border-2 focus:border-neon-magenta focus:shadow-[0_0_20px_rgba(236,72,153,0.4)] ${
